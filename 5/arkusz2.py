...
print(data[data['Amount'] > 47500])
#   Sales Date Sales Person  Amount
# 0 2018-05-12   Sila Ahmed   60000
# 1 2019-12-06  Mir Hossain   50000

data_part = pd.DataFrame(excel_data, columns=['Sales Date', 'Sales Person'])
print(data_part)
#   Sales Date    Sales Person
# 0 2018-05-12      Sila Ahmed
# 1 2019-12-06     Mir Hossain
# 2 2020-08-09    Sarmin Jahan
# 3 2021-04-07  Mahmudul Hasan
